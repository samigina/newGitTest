...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'tutorialROSOpenCV' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dana-irl/OpenCVPractice/install/${idir}'.  Ask the maintainer 'dana-irl <dana-irl@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dana-irl/OpenCVPractice/install/lib;/home/dana-irl/Cpts483-Intro-To-Robotics/devel/lib;/opt/ros/hydro/lib)
